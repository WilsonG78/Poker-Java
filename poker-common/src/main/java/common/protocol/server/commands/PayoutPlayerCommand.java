...
@AllArgsConstructor
@NoArgsConstructor
public class PayoutPlayerCommand implements ServerCommand {
    private GameId gameId;
    private PlayerId playerId;
    private ServerActions action;
    private PlayerId payingOutPlayerId;
    private int amount;
    ...
    public void parseFromString(String input) {
        ...
        if (params.containsKey("PLAYER")) {
            setPayingOutPlayerId(PlayerId.fromString(params.get("PLAYER")));
        }
    ...
    public String toReadableString(){
        ...
        stringBuilder.append(payingOutPlayerId);
