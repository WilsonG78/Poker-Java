...
@AllArgsConstructor
@NoArgsConstructor
public class ClientServerCommand implements  PokerCommandFactory{
    ...
    public ClientServerCommand parserFromString(String input){
        ClientServerCommand cmd = new ClientServerCommand();
        ...
        ClientActions newAction = ClientActions.fromString(mainTokens[3]);
